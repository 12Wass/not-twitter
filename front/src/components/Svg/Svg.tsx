...
const Svg: React.FC<Props> = ({svg}) => {
    // Ce composant contient tous les SVG utilisés.
    if (svg === "message") {
        return (
        ...
        return (
            ...
            >
                ...
                <path
                    ...
                    d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"
                />
                <line x1="0" y1="0" x2="200" y2="200" strokeWidth="2" strokeLinejoin="round" />
            </svg>
        );
    }
    if (svg === "red-closed-eye"){
        return (
            <svg
                xmlns="http://www.w3.org/2000/svg"
    ...
    if (svg === "comment") {
        return (
            <svg className="text-center h-6 w-6" fill="none" strokeLinecap="round"
                 strokeLinejoin="round" strokeWidth="2" stroke="currentColor"
                 viewBox="0 0 24 24">
                <path
